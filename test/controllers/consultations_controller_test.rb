...
class ConsultationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultation" do
    assert_difference('Consultation.count') do
      post consultations_url, params: { consultation: { books: @consultation.books, links: @consultation.links, references: @consultation.references } }
    end
  ...
  test "should update consultation" do
    patch consultation_url(@consultation), params: { consultation: { books: @consultation.books, links: @consultation.links, references: @consultation.references } }
