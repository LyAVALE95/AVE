...
class AlgorithmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create algorithm" do
    assert_difference('Algorithm.count') do
      post algorithms_url, params: { algorithm: { avaible: @algorithm.avaible, description: @algorithm.description, level: @algorithm.level, name: @algorithm.name, price: @algorithm.price, value: @algorithm.value } }
    end
  ...
  test "should update algorithm" do
    patch algorithm_url(@algorithm), params: { algorithm: { avaible: @algorithm.avaible, description: @algorithm.description, level: @algorithm.level, name: @algorithm.name, price: @algorithm.price, value: @algorithm.value } }
